...
package io.wookey.coinevo.data;


import android.util.Log;
import io.wookey.coinevo.model.NetworkType;
import io.wookey.coinevo.model.WalletManager;
...
public class Node {
    ...
    static public int getDefaultLevinPort() {
        ...
        switch (WalletManager.getInstance().getNetworkType()) {
            case NetworkType_Mainnet:
                DEFAULT_LEVIN_PORT = 33330;
                break;
            case NetworkType_Testnet:
                DEFAULT_LEVIN_PORT = 44440;
                break;
            case NetworkType_Stagenet:
                DEFAULT_LEVIN_PORT = 55550;
                break;
            default:
    ...
    static public int getDefaultRpcPort() {
        ...
        switch (WalletManager.getInstance().getNetworkType()) {
            case NetworkType_Mainnet:
                DEFAULT_RPC_PORT = 33331;
                break;
            case NetworkType_Testnet:
                DEFAULT_RPC_PORT = 44441;
                break;
            case NetworkType_Stagenet:
                DEFAULT_RPC_PORT = 55551;
                break;
            default:
                throw new IllegalStateException("unsupported net " + WalletManager.getInstance().getNetworkType());
        }
