...
package io.wookey.coinevo.model;


import android.util.Log;
import io.wookey.coinevo.data.Node;
import io.wookey.coinevo.ledger.Ledger;
...
public class WalletManager {
    ...
    public Wallet.Device queryWalletDevice(String keys_file_name, String password) {
        ...
        return Wallet.Device.values()[device + 1]; // mapping is coinevo+1=android
    }
...
//TODO static std::tuple<bool, std::string, std::string, std::string, std::string> checkUpdates(const std::string &software, const std::string &subdir);
    ...
    //TODO: maybe put these in an enum like in coinevo core - but why?
