...
public class RestoreHeight {
    ...
    RestoreHeight() {
        blockheight.put("2020-02-15", 1L);
        blockheight.put("2020-02-15", 45L);
        blockheight.put("2020-02-17", 203L);
        blockheight.put("2020-02-19", 1000L);
        blockheight.put("2020-02-22", 5000L);
        blockheight.put("2020-02-28", 10000L);
        blockheight.put("2020-03-07", 15000L);
        blockheight.put("2020-03-20", 24673L);
    }
    ...
    public long getHeight(final Date date) {
        ...
        cal.setTime(date);
        cal.add(Calendar.DAY_OF_MONTH, -1); // give it some leeway
        if (cal.get(Calendar.YEAR) < 2020)
            return 0;
        if ((cal.get(Calendar.YEAR) == 2020) && (cal.get(Calendar.MONTH) <= 3))
            // before May 2014
            return 0;
